...
import { CardBack, type CardBackTone } from './CardBack'

type PlayPileZoneProps = {
  labels: [string, string, string]
  className?: string
  cardBackTone?: CardBackTone
}
...
export function PlayPileZone({ labels, className, cardBackTone = 'blue' }: PlayPileZoneProps) {
