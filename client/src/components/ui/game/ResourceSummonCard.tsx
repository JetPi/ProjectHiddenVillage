...
import summonCardImage from '@/assets/SummonCard-hud.webp'
...
const RESOURCE_CARD_IMAGE_CLASS = 'h-full w-full rounded-none object-contain p-[1px] [image-rendering:auto]'
  ...
  return (
    <PlayCard
      className={twMerge(
        ...
        isSummonCardReady ? 'rotate-0' : 'rotate-90',
        className,
      )}
    >
      <CardImage
