...
public sealed class Player1RuntimeDeckCardConfiguration : IEntityTypeConfiguration<Player1RuntimeDeckCard>
{
    public void Configure(EntityTypeBuilder<Player1RuntimeDeckCard> entity)
    {
        entity.ToTable("player1_runtime_deck_cards");
        ...
        entity.HasOne(record => record.GameInstance)
            .WithMany(record => record.Player1RuntimeDeckCards)
